           ...
           <div className="container">
               <div className="list-items">
                <div className="individuals twoItems">
                    <p key={exchanges.id}>{exchanges.trust_score_rank}</p>
                    <img className="logo-img" src={exchanges.image} alt='img logo'></img>
                </div>
            ...
            <div className="individuals url">
                <p><a target="_blank" href={exchanges.url}>{exchanges.url}</a></p>
            </div>
            <div className="individuals">
